...
export const seedMembers = [
  { id: "m-1", name: "Elena Rostova", role: "Staff AI Engineer", skills: ["rag", "evaluation", "guardrails"], stuck: "Optimizing real-time LLM validation latency", experienceLine: "Solved a similar production-evaluation problem 2 months ago", bio: "Former researcher in prompt safety. Maintained RAG evaluation templates.", roles: ["seeking", "helping", "organizing"], location: { city: "Vadodara, GJ", region: "ap-south-1", venue: "AWS Community Day Hall A - Vadodara", distanceMiles: 2, pingMs: 3 } },
  { id: "m-2", name: "Alex Rivera", role: "Backend Architect", skills: ["rag", "indexing", "chunking"], stuck: "Ingesting 100M+ PDF pages with correct metadata hierarchy", experienceLine: "Solved a similar index-synchronization problem 3 months ago", bio: "10+ years backend engineering. Built open source parsing pipelines.", roles: ["seeking", "helping"], location: { city: "Ahmedabad, GJ", region: "ap-south-1", venue: "SG Highway Tech Hub", distanceMiles: 68, pingMs: 12 } },
  { id: "m-3", name: "Devon Chen", role: "Database Engineer", skills: ["vector-db", "pgvector", "performance"], stuck: "Benchmarking PGVector index build time on massive graphs", experienceLine: "Solved a similar PGVector latency problem 5 months ago", bio: "Postgres contributor. Specialized in database performance engineering.", roles: ["seeking", "helping"], location: { city: "Vadodara, GJ", region: "ap-south-1", venue: "Sayajigunj Tech Hub - Vadodara", distanceMiles: 5, pingMs: 4 } },
  { id: "m-4", name: "Sarah Jenkins", role: "Security Researcher", skills: ["security", "injection", "guardrails"], stuck: "Testing jailbreaks on deepseek models", experienceLine: "Solved a similar injection-security problem 1 month ago", bio: "Securing LLMs since GPT-3. Creator of the safety-probe tool.", roles: ["seeking", "helping"], location: { city: "Surat, GJ", region: "ap-south-1", venue: "Surat IT Park", distanceMiles: 95, pingMs: 16 } },
  { id: "m-5", name: "Tariq Mahmood", role: "Platform Engineer", skills: ["vllm", "local-llm", "inference"], stuck: "Scaling vLLM throughput under highly concurrent API requests", experienceLine: "Solved a similar local-inference speed problem 6 months ago", bio: "Kubernetes expert. Spends weekends squeezing tokens out of consumer GPUs.", roles: ["seeking", "organizing"], location: { city: "Mumbai, MH", region: "ap-south-1", venue: "AWS Mumbai Cloud Center", distanceMiles: 240, pingMs: 22 } },
